      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo base_url().'supplier/do_add'?>" id="form_handle">
              <div class="box-body">
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" id="inputEmail3" type="text" name="com_name">
                  </div>
                </div>
                </div>
