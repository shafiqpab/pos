<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y');?> <a href="##">Shop Cart</a>.</strong> All rights reserved.
  </footer>
...
<script type="text/javascript">
  ...
  { 
    //================= for load cart data ==========================
    var curl = $("#cart_form").attr('action');
    $('#detail_cart').load(baseurl+"purchase/load_cart");
    $('#detail_cart').load(baseurl+"sales/load_cart");
  ...
  function selectItem2(val) 
  {
    ...
    // $('#sales_form').submit();
    $.ajax({
        url : baseurl+"purchase/add_to_cart",
        method : "POST",
        data : 'item='+item,
        success: function(data)
        {
