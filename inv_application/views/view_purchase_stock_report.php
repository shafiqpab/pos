      ...
      <div class="row">
        ...
        <?php echo $this->session->flashdata('msg');?>
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo base_url().'reports/view_purchase_stock_report'?>">
              <div class="box-body">
              
                <div class="col-md-4">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Stock Name</label>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $num=1; foreach($result->result() as $row){ ?>
                <tr>
          ...
          <!-- /.info-box -->
          <?php }else{ ?> 
          <div class="alert alert-danger">Data not available!</div>
          <?php
           }
