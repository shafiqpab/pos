      ...
      <div class="row">
        ...
        <?php echo $this->session->flashdata('msg');?>
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo base_url().'transaction/add_deposit'?>">
              <div class="box-body">
              <div class="col-md-4">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url().'transaction/deposit_edit/'.$row->id;;?>"><i class="fa fa-edit"></i> Edit</a></li>
                    <li><a class="deletebtn" href="<?php echo base_url().'transaction/deposit_delete/'.$row->id;?>"><i class="fa fa-trash"></i> Delete</a></li>
                  </ul>
                </div></td>
                </tr>
                <?php $num++; } ?>
