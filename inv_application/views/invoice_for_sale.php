    ...
    <section class="invoice">
      ...
      <div class="row page-header">
        ...
        <div class="col-xs-10 text-right">
          <a target="_blank" href="<?php echo base_url().'sales/invoice_print/'.$this->uri->segment(3);?>" class="btn btn-info"><i class="fa fa-print"></i> Print</a>
           <a href="<?php echo base_url().'sales/save_as_pdf/'.$this->uri->segment(3);?>" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> PDF</a>
          <a href="javascript:void(0)" data-controller="sales" data-tid="<?php echo $this->uri->segment(3);?>" class="btn btn-success" id="load_modal"><i class="fa fa-plus"></i> Add Payment</a>
