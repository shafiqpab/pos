      ...
      <div class="row">
        ...
        <?php echo $this->session->flashdata('msg');?>
          ...
          <div class="box box-info">
            ...
            <form method="post" action="<?php echo base_url().'purchase/update_purchase_cart/'.$this->uri->segment(3);?>">
            ...
            ?>
                ...
                <td width="100">
                  <div class="btn-group">
                  <a href="<?php echo base_url().'purchase/delete/'.$items['rowid'];?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                </div>
                </td>
                </tr>
                <?php 
              ...
              <form class="form-horizontal" method="post" id="purchase_item_form" action="<?php echo base_url().'purchase/update_purchase/'.$row[0]->salesid;?>">
              <div class="box-body">
